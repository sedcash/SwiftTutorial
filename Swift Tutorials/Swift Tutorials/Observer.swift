...
// MARK: Observer - Lets objects subscribe for notifications iwthout being tightly coupled to the sender

//Avoid: not unregistering oberserved before releasing them
// Subject only knows about the Protocol
